      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 text-center">
        ...
        >
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            A visual journey through our recent initiatives, events, and the
            lives we have touched together.
          </p>
        </motion.div>
      </div>
          ...
          >
            {marqueeImages.map((image, index) => (
              ...
              >
                ...
                {/* Overlay and Caption */}
                <div
                  className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent transition-opacity duration-500 opacity-100 md:opacity-0 md:group-hover:opacity-100"
                >
